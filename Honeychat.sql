create table TABLE_USER (Username varchar(32), User_ID int(10) not null auto_increment, User_ROLE int(10) default 0, PWD_HASH varchar(255) not null, primary key (User_ID), unique index (User_ID));
